...
| [cap.workcell.services](#cap-workcell-services) | Logical service endpoint with material process and health information | Observed: managed_host_service.rs (6/6) and hosting_conformance.rs (4/4) pass |
...
**Current standing:** Observed: managed_host_service.rs (6/6) and hosting_conformance.rs (4/4) pass.
...
**Operation:** Persist, scan, declare and adopt harness-instance records; observe one bound PID over a bounded interval.

**Result:** A conflict-safe registry distinguishing observed live/stale instances from declared-unverified intent, with actual running-executable identity and exact-provenance CPU/memory observations.

**Current standing:** Observed in native registry/scanner tests and a real macOS Codex process usage reading; GPU, VRAM, network, peak RSS and storage I/O remain explicitly unsupported.
